...
class ConexaoMysql {
    ...
    protected $mysqli;
    protected $hostname = 'localhost'; //Endereço do servidor
    protected $user = 'root'; //Usuario que acessa o banco
    protected $pass = ''; //Senha do usuário
    protected $dataBase = 'carrinhoBrasil'; //Nome da base de dados
    ...
    public function Conectar(){
        $this->mysqli = new mysqli($this->hostname, $this->user, $this->pass, $this->dataBase);
